...
from model.VGGSound_net import AClassify,VClassify,AVClassifier_Sum,GradMod
from dataloader.VGGSound_loader import VGGSound_DataLoader

class VGGSound_Task(object):
    def __init__(self,cfgs):
        super(VGGSound_Task,self).__init__()
        self.cfgs = cfgs
    ...
    def load_dataloader(self):
        loader = VGGSound_DataLoader(self.cfgs)
